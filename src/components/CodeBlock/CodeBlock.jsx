  ...
  return (
    <div className="code-block">
      ...
      <code className="code-block__code">
        ...
        &nbsp; <span style={{ color: property }}>justify-content</span>: <span style={{ color: value }}>space-between</span>; <br />
        &nbsp; <span style={{ color: property }}>align-items</span>: <span style={{ color: value }}>center</span>; <br />
        &#125; <br /><br />

        <span style={{ color: classSel }}>.logo</span> &#123; <br />
        &nbsp; <span style={{ color: property }}>color</span>: <span style={{ color: value }}>#fff</span>; <br />
